...
<div class="page-content">
    ...
    <div class="container-fluid">
        <form action="{{route('admin.upload_colour')}}" method="post" enctype="multipart/form-data">
            @csrf
        <div class="card mb-4">
            <div class="card-body">	
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="colour" id="name" class="form-control" placeholder="Name" required>	
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="slug">Colour Code <span style="color: red">*</span></label>
                            <input type="color" name="code" id="slug" class="form-control" required>	
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
        ...
        <div class="pb-5 pt-3">
            <button type="submit" class="btn btn-primary">Upload Colour</button>
        </div>
        </form>
    </div>
</div>
