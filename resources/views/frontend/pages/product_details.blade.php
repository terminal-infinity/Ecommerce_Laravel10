							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="/productimage/{{$product->image}}">
									<div class="wrap-pic-w pos-relative">
										...
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="/productimage/{{$product->image}}">
								...
								@if ($img != "")
								<div class="item-slick3" data-thumb="/productimage/{{$img->image}}">
									<div class="wrap-pic-w pos-relative">
										<img src="/productimage/{{$img->image}}" alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="/productimage/{{$img->image}}">
											<i class="fa fa-expand"></i>
										</a>
									</div>
								</div>
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
                                        <select class="js-select2" name="time">
                                            ...
                                            @if(in_array($sizes->size, $selectedSize))
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="time">
                                            ...
                                            @if(in_array($colours->colour, $selectedColors))
                                            <option value="{{ $colours->colour }}">{{ $colours->colour }}</option>
                                             @endif
                                             @endforeach
										</select>
										<div class="dropDownSelect2"></div>
	...
	<section class="sec-relate-product bg0 p-t-45 p-b-105">
		<div class="container">
			...
			<div class="wrap-slick2">
				<div class="slick2">
					@foreach ($relatedproduct as $product_item)
            		@if ($product_item != '')
